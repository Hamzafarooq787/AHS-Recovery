  ...
  return (
    <section className="relative w-full overflow-hidden border-b border-white/5 min-h-[85vh] flex items-center">
      <Image
        ...
        sizes="100vw"
      />
      <div className="absolute inset-0 bg-gradient-to-b from-background-dark/95 via-background-dark/80 to-background-dark" />

      <div className="relative z-10 w-full px-6 md:px-20 lg:px-40 py-20">
